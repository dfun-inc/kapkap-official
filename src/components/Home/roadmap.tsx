      ...
      <div className="max-w-[1920px] mx-auto px-10 lg:px-18 2xl:px-24 pt-6 pb-12">
        ...
        <div className="mt-15 text-lg">
          ...
          <div className="relative pt-6 text-[#8A84A3]">
            ...
            <div className="flex items-start relative z-1 mt-6">
              <div className="border-[2px] border-[#4B436F] bg-[#201e2a] rounded-full w-5 h-5 flex items-center justify-center"></div>
              <div className={aniItemClass + " animate__animated animate__delay-1500 ml-2 md:ml-4 leading-none flex-1"}>{t('roadmap.step6')}</div>
            </div>
            <div className="flex items-start relative z-1 mt-6">
              <div className="border-[2px] border-[#4B436F] bg-[#201e2a] rounded-full w-5 h-5 flex items-center justify-center"></div>
              <div className={aniItemClass + " animate__animated animate__delay-1750 ml-2 md:ml-4 leading-none flex-1"}>{t('roadmap.step7')}</div>
            </div>
          </div>
        </div>
      </div>
