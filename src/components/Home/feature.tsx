    ...
    <section id="home-section-1" className="home-section-1 bg-[#121212]">
      <div className="max-w-[1920px] mx-auto px-10 lg:px-24 py-16">
        ...
        <div className="md:flex gap-x-5 items-stretch justify-between mt-12">
          <div className="w-full feature-item feature-item-1 px-5 lg:px-10 py-3 lg:py-7 overflow-hidden rounded-3xl">
          ...
          <div className="w-full feature-item feature-item-2 px-5 lg:px-10 py-3 lg:py-7 overflow-hidden rounded-3xl mt-5 md:mt-0">
        ...
        <div className="md:flex gap-x-5 items-stretch justify-between">
          <div className="flex-1 w-full feature-item feature-item-3 px-5 lg:px-10 py-3 lg:py-7 overflow-hidden rounded-3xl mt-5">
          ...
          <div className="flex-1 w-full md:w-[47.5%] feature-item feature-item-4 px-5 lg:px-10 py-3 lg:py-7 overflow-hidden rounded-3xl mt-5">
