      ...
      <div className="max-w-[1920px] mx-auto px-5 lg:px-18 2xl:px-24 py-16">
        ...
        <div className={aniClass + " animate__animated animate__delay-1000 mt-5"}>
          <Swiper className="case-swiper" 
            ...
            autoplay={{
              delay: 20000, // 轮播间隔，单位毫秒
              disableOnInteraction: false, // 用户滑动后是否停止自动播放
            }}>
            {list.map((item, index) => (
            <SwiperSlide key={index} className="overflow-hidden rounded-xl bg-[#201E2A] w-full">
              <div className="relative">
                <div className="md:absolute flex flex-wrap top-0 left-0 w-full justify-between items-stretch overflow-hidden py-3 md:py-0">
                  <div className="relative z-1 bg-[#201E2A] w-1/2 md:w-auto md:min-w-[17.5%] flex items-center justify-center">
                    ...
                    <div className="case-left-shape absolute left-full bottom-0 hidden md:block w-10 h-full bg-[#201E2A]"></div>
                  </div>
                  <div className="relative z-2 w-full md:w-auto order-3 md:order-2 md:flex-1 flex flex-wrap justify-between items-center mt-2 md:mt-[2px] px-5 lg:px-10">
                    <div className="w-3/10 md:w-auto text-center mt-2 md:mt-0">
                      <div className="text-xs lg:text-sm text-[#8D73FF]">{t('case.player')}</div>
                      <div className="lg:text-[26px]">{item.player}</div>
                    </div>
                    <div className="w-4/10 md:w-auto text-center mt-2 md:mt-0">
                  ...
                  <div className="relative z-1 order-2 md:order-3 bg-[#201E2A] w-1/2 md:w-auto md:min-w-[17.5%] flex items-center justify-center">
                    ...
                    <div className="case-right-shape absolute right-full bottom-0 hidden md:block w-10 h-full bg-[#201E2A]"></div>
                  </div>
                </div>
                <div className="w-full h-5 lg:h-7 hidden md:block bg-[#201E2A]"></div>
