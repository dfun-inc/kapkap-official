        ...
        <div className="w-full bg-black rounded-[20px] overflow-hidden">
          <div className="p-6">
            ...
            <div className="mt-1 flex items-center justify-center md:justify-between space-x-2 px-6">
              ...
              <input className="max-w-[170px] md:max-w-[220px] md:flex-1 shrink-1 h-15 text-center text-white bg-[#1a1a1a] text-[20px] rounded-[10px]" value={buyAmount} onChange={handleBuyAmountChange} />
