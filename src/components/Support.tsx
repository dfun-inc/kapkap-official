...
export default function Support() {
  ...
  const { modalTrigger } = useAppContext();
  ...
  return (
    <>
      <Modal
        ...
        ariaHideApp={false}
      >
        <div className="support-modal modal-content w-screen bg-[#121212] relaitve">
          <div className="modal-top absolute bottom-full left-0 w-1/2 pr-[30px] lg:pr-[60px]">
            <div className="w-full h-[30px] lg:h-[60px] bg-[#121212]"></div>
            <div className="absolute top-0 right-0 w-0 h-0 border-t-0 border-l-0 border-b-[#121212] border-r-transparent border-b-[30px] border-r-[30px] lg:border-b-[60px] lg:border-r-[60px]"></div>
          </div>
          <div className="modal-bottom absolute top-full right-0 w-2/3 pl-[30px] lg:pl-[60px]">
            <div className="w-full h-[30px] lg:h-[60px] bg-[#121212]"></div>
            <div className="absolute top-0 left-0 w-0 h-0 border-b-0 border-r-0 border-t-[#121212] border-l-transparent border-t-[30px] border-l-[30px] lg:border-t-[60px] lg:border-l-[60px]"></div>
          </div>
              ...
              <div className="mt-6">
                <form>
                  ...
                  <textarea className={"w-full border border-[#6E4DFF] rounded-lg p-2 text-[6E4DFF] text-lg md:text-xl min-h-30 " + (questionIdx == 4 ? 'block' : 'hidden')} 
                    name="expectProfit" value={form.expectProfit} onChange={handleChange} />
                  <textarea className={"w-full border border-[#6E4DFF] rounded-lg p-2 text-[6E4DFF] text-lg md:text-xl min-h-30 " + (questionIdx == 5 ? 'block' : 'hidden')} 
                    name="support" value={form.support} onChange={handleChange} />
                  <textarea className={"w-full border border-[#6E4DFF] rounded-lg p-2 text-[6E4DFF] text-lg md:text-xl min-h-30 " + (questionIdx == 6 ? 'block' : 'hidden')} 
                    name="visitType" value={form.visitType} onChange={handleChange} />
