  ...
  return (
    <section className="ip-section bg-[#121212] relative z-2">
      <div className="max-w-[1920px] mx-auto relative">
        ...
        <div className="ip-desc md:absolute md:bottom-20 2xl:bottom-26 pt-3 md:pt-0 left-0 z-1 w-full z-1">
          <div className={aniDesc + " animate__animated animate__delay-500 md:text-[20px] 2xl:text-[24px] text-[#CFC4FF] text-center px-3"}>
            {t('ip.desc')}
          </div>
        </div>
      </div>
